...
// in malinali/test/translate_page_test.dart.
...
import 'package:marian_flutter/src/marian_service.dart' as _i6;
import 'package:marian_flutter/src/rust/api/marian.dart' as _i8;
...
/// A class which mocks [TranslationModelService].
///
...
/// A class which mocks [MarianService].
///
/// See the documentation for Mockito's code generation for more information.
class MockMarianService extends _i1.Mock implements _i6.MarianService {
  MockMarianService() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i4.Future<String> translate(
    String? text, {
    _i8.TranslationConfig? config = const _i8.TranslationConfig(
      numBeams: 2,
      maxNewTokens: 24,
      lengthPenalty: 1.2,
      noRepeatNgramSize: 3,
      ...
      (super.noSuchMethod(
            Invocation.method(#translate, [text], {#config: config}),
